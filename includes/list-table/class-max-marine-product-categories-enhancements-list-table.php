 ...
 * @subpackage Max_Marine\Product_Categories_Enhancements/admin
 * @author     David Baumwald <david@dream-encode.com>
 */

namespace Max_Marine\Product_Categories_Enhancements\Core\ListTable;
 ...
 * @author     David Baumwald <david@dream-encode.com>
 */
class Max_Marine_Product_Categories_Enhancements_List_Table extends WP_List_Table {
	...
	public function __construct() {
		parent::__construct(
			array(
				'singular' => __( 'Thing', 'max-marine-product-categories-enhancements' ),
				'plural'   => __( 'Things', 'max-marine-product-categories-enhancements' ),
				'ajax'     => false,
			)
		);
	}
	...
	public function no_items() {
		esc_html_e( 'No things.', 'max-marine-product-categories-enhancements' );
	}
	...
	public function column_default( $item, $column_name ) {
		switch ( $column_name ) {
			case 'timestamp':
				...
				if ( ! $date ) {
					$date = __( 'N/A', 'max-marine-product-categories-enhancements' );
				}
	...
	public function get_columns() { // @phpcs:ignore @phpstan-ignore-line
		$columns = array(
			'timestamp' => __( 'Date', 'max-marine-product-categories-enhancements' ),
			'id'        => __( 'ID', 'max-marine-product-categories-enhancements' ),
		);
